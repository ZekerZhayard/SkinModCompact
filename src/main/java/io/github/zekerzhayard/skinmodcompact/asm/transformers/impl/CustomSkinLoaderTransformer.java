                                ...
                                new AbstractInsnTransformer() {
                                    ...
                                    public boolean isTargetInsn(AbstractInsnNode ain) {
                                        if (ain instanceof MethodInsnNode) {
                                            ...
                                            return min.getOpcode() == Opcodes.INVOKESPECIAL && min.owner.equals("customskinloader/profile/UserProfile") && min.name.equals("<init>") && min.desc.equals("()V");
                                        }
                                        return false;
                                    }
                                    ...
                                    public boolean isTargetInsn(AbstractInsnNode ain) {
                                        if (ain instanceof JumpInsnNode) {
                                            ...
                                            return jin.getOpcode() == Opcodes.IF_ICMPGE;
                                        }
                                        return false;
                                    }
                                    ...
                                    public boolean isTargetInsn(AbstractInsnNode ain) {
                                        if (ain instanceof MethodInsnNode) {
                                            MethodInsnNode min = (MethodInsnNode) ain;
                                            return min.getOpcode() == Opcodes.INVOKEVIRTUAL && min.owner.equals("customskinloader/profile/UserProfile") && min.name.equals("mix") && min.desc.equals("(Lcustomskinloader/profile/UserProfile;)V");
                                        }
                                        return false;
                                    }
                        ...
                        return new AbstractInsnTransformer[] {
                                new AbstractInsnTransformer() {
                                    ...
                                    public boolean isTargetInsn(AbstractInsnNode ain) {
                                        if (ain instanceof MethodInsnNode) {
                                            MethodInsnNode min = (MethodInsnNode) ain;
                                            return min.getOpcode() == Opcodes.INVOKEVIRTUAL && min.owner.equals("java/lang/Thread") && min.name.equals("start") && min.desc.equals("()V");
                                        }
                                        return false;
                                    }
